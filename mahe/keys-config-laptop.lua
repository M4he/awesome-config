...
function hotkeys:init(args)
	...
	keyseq[3][7][3] = {
		{
			{}, "p", function() awful.spawn.with_shell("bash " .. awful.util.get_configuration_dir() .. "scripts/xrandr-laptop.sh primary") end,
			{ description = "Only activate PRIMARY screen", group = "Monitor management", keyset = { "p" } }
		},
		{
			{}, "s", function() awful.spawn.with_shell("bash " .. awful.util.get_configuration_dir() .. "scripts/xrandr-laptop.sh secondary") end,
			{ description = "Only activate SECONDARY screen", group = "Monitor management", keyset = { "s" } }
		},
		{
			{}, "e", function() awful.spawn.with_shell("bash " .. awful.util.get_configuration_dir() .. "scripts/xrandr-laptop.sh extend") end,
			{ description = "Extend the internal screen to the right", group = "Monitor management", keyset = { "e" } }
		},
		{
			{}, "m", function() awful.spawn.with_shell("bash " .. awful.util.get_configuration_dir() .. "scripts/xrandr-laptop.sh mirror") end,
			{ description = "Mirror both screens", group = "Monitor management", keyset = { "m" } }
		},
		{
			{}, "o", function() awful.spawn.with_shell("bash " .. awful.util.get_configuration_dir() .. "scripts/xrandr-laptop.sh ontop") end,
